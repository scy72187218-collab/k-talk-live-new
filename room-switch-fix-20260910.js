...
(function(){
  ...
  function apply(){
    ...
    earn.style.setProperty('bottom','250px','important');
  ...
  if(!document.getElementById('ktSecretBottomOnlyStyle20260911')){
    ...
    st.textContent=''
      ...
      +'@media(max-width:390px){.ktsecret-room .ktsecret-earn-row{right:5px!important;bottom:244px!important;width:145px!important;height:58px!important}.ktsecret-room .ktsecret-chat{right:154px!important;bottom:64px!important}.ktsecret-room .ktsecret-gifts{bottom:3px!important}}';
    document.head.appendChild(st);
  }
