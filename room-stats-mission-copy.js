...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent='\
      ...
      #screen .ktsecret-room .kt-room-stats-copy{display:grid!important;grid-template-columns:.95fr .7fr 1.35fr!important;width:100%!important;left:0!important;right:auto!important;transform:none!important;flex:0 0 32px!important;min-height:32px!important;gap:2px!important;}\
      #screen .ktsecret-room .kt-room-stats-copy button,#screen .ktsecret-room .kt-room-stats-copy .kt-room-viewers-copy{font-size:9px!important;border-radius:8px!important;padding:0 1px!important;}\
      ...
      @media(max-width:390px){#screen .kt-room-stats-copy{flex-basis:38px!important;min-height:38px!important;gap:2px!important}#screen .kt-room-stats-copy button,#screen .kt-room-stats-copy .kt-room-viewers-copy{font-size:10px!important;padding:0 1px!important}#screen .ktsecret-room .kt-room-stats-copy{flex-basis:30px!important;min-height:30px!important}#screen .ktsecret-room .kt-room-stats-copy button,#screen .ktsecret-room .kt-room-stats-copy .kt-room-viewers-copy{font-size:9px!important}}';
