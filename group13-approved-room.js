...
(function(){
  ...
  function renderApprovedGroup13(){
    ...
    s.innerHTML='<style id="ktg13ApprovedStyle">'
      ...
      +'.ktg13-mid{flex:0 0 74px;display:grid;grid-template-columns:minmax(0,1fr) 46%;gap:8px;align-items:end;min-height:0}.ktg13-chat{position:static;width:100%;height:74px;max-height:74px;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;pointer-events:none;padding:2px 6px 3px;background:#000}.ktg13-chat:empty:before{content:"💬 채팅 메시지가 여기에 표시됩니다";color:#777;font-size:11px;font-weight:800;margin:auto 0 4px}.ktg13-chat-line{display:flex;gap:7px;align-items:baseline;margin-top:5px;color:#fff;font-size:12px;font-weight:800;text-shadow:0 1px 2px #000,0 0 4px #000}.ktg13-chat-line b{color:#65c8ff;font-weight:950}.ktg13-chat-line span{color:#fff}'
      +'.ktg13-earn{height:64px;display:flex;align-items:flex-end;justify-content:flex-end}.ktg13-earn #myEarnHud{position:static!important;left:auto!important;bottom:auto!important;transform:none!important;width:100%!important;min-width:0!important;max-width:none!important;margin:0!important;padding:4px 8px!important;border:1px solid #d2a936!important;border-radius:12px!important;background:linear-gradient(135deg,#17140be8,#0d0d12e8)!important;color:#fff!important}'
      +'.ktg13-gifts{flex:0 0 80px;display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:3px}.ktg13-gift{min-width:0;border:1px solid #33343a;border-radius:7px;background:linear-gradient(180deg,#111116,#09090c);color:#fff;padding:3px 1px 3px;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;overflow:hidden}.ktg13-gift img{width:42px;max-width:86%;height:36px;object-fit:contain;filter:drop-shadow(0 2px 4px #000)}.ktg13-emoji{height:36px;display:grid;place-items:center;font-size:30px;line-height:1;filter:drop-shadow(0 0 5px #ff5bd4)}.ktg13-gift b{color:#ffe23e;font-size:10px;line-height:1.05}.ktg13-gift small{display:block;margin-top:2px;color:#fff;font-size:8px;line-height:1.05;font-weight:900;text-align:center;white-space:normal}'
      +'.ktg13-tools{flex:0 0 68px;display:grid;grid-template-columns:repeat(6,1fr);gap:3px;align-items:start}.ktg13-tool{border:0;background:none;color:#fff;min-width:0;font-weight:900;font-size:10px;display:grid;justify-items:center;gap:3px}.ktg13-tool i{width:45px;height:45px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#1b1b20,#0b0b0f);border:1px solid #35363d;font-style:normal;font-size:23px;box-shadow:inset 0 0 13px #ffffff08}.ktg13-tool:first-child i{color:#fff;box-shadow:0 0 12px #a53fff66,inset 0 0 13px #ffffff08}.ktg13-tool span{font-size:10px;color:#fff;white-space:nowrap}'
      +'@media(max-width:390px){.ktg13-room{padding-left:4px;padding-right:4px;gap:3px}.ktg13-head{flex-basis:58px;padding:4px 8px}.ktg13-air strong{font-size:18px}.ktg13-air small{font-size:10px}.ktg13-brand{font-size:17px}.ktg13-attend{min-width:112px;height:38px;font-size:17px;padding:0 9px}.ktg13-led{flex-basis:50px}.ktg13-led-track{font-size:21px}.ktg13-stats{flex-basis:42px;gap:4px}.ktg13-stats button,.ktg13-viewers{font-size:12px}.ktg13-main{grid-template-columns:42% 58%}.ktg13-guest{font-size:12px}.ktg13-mid{flex-basis:66px;grid-template-columns:minmax(0,1fr) 47%;gap:5px}.ktg13-chat{height:66px;max-height:66px;padding-left:3px;padding-right:3px}.ktg13-chat-line{font-size:10px}.ktg13-earn{height:58px}.ktg13-earn #myEarnHud{padding:3px 5px!important}.ktg13-gifts{flex-basis:72px}.ktg13-gift img{height:31px}.ktg13-emoji{height:31px;font-size:27px}.ktg13-gift b{font-size:9px}.ktg13-gift small{font-size:7px}.ktg13-tools{flex-basis:61px}.ktg13-tool i{width:40px;height:40px;font-size:20px}.ktg13-tool span{font-size:9px}}'
      +'</style>'
      +'<section class="ktg13-room">'
        ...
        +'<div class="ktg13-mid">'
          ...
          +'<div class="ktg13-earn"><button id="myEarnHud" onclick="toggleMyEarnings()">'
            +'<div style="display:flex;align-items:center;justify-content:center;gap:5px"><span style="font-size:9px;color:#8fe8ff;font-weight:950;white-space:nowrap">🔒 내 수익 · 본인만 표시</span><b id="hudEarnNet" style="font-size:14px;color:#ffe071;white-space:nowrap">'+esc(net)+'</b></div>'
            +'<div id="myEarnDetail" style="display:grid;grid-template-columns:1fr 1fr;gap:5px;margin-top:2px;font-size:9px;color:#ddd"><span id="hudEarnRoses">'+esc(roses)+'</span><span id="hudEarnRate" style="text-align:right">일반회원 · '+esc(rate)+'</span></div>'
          +'</button></div>'
        +'</div>'
