...
(function(){
  ...
  function renderApprovedGroup13(){
    ...
    s.innerHTML='<style id="ktg13ApprovedStyle">'
      ...
      +'.ktg13-mid{flex:0 0 74px;display:grid;grid-template-columns:minmax(0,1fr) 38%;gap:7px;align-items:end;min-height:0}.ktg13-chat{position:relative;width:100%;height:74px;max-height:74px;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;pointer-events:none;padding:1px 6px 2px;background:transparent;transform:translateY(-28px);z-index:6}.ktg13-chat:empty:before{content:"💬 채팅 메시지가 여기에 표시됩니다";color:#777;font-size:10px;font-weight:800;margin:auto 0 3px}.ktg13-chat-line{display:flex;gap:6px;align-items:baseline;margin-top:3px;color:#fff;font-size:11px;font-weight:800;text-shadow:0 1px 2px #000,0 0 4px #000}.ktg13-chat-line b{color:#65c8ff;font-weight:950}.ktg13-chat-line span{color:#fff}'
      ...
      +'@media(max-width:390px){.ktg13-room{padding-left:4px;padding-right:4px;gap:3px}.ktg13-head{flex-basis:58px;padding:4px 8px}.ktg13-air strong{font-size:18px}.ktg13-air small{font-size:10px}.ktg13-brand{font-size:17px}.ktg13-attend{min-width:112px;height:38px;font-size:17px;padding:0 9px}.ktg13-led{flex-basis:50px}.ktg13-led-track{font-size:21px}.ktg13-stats{flex-basis:42px;gap:4px}.ktg13-stats button,.ktg13-viewers{font-size:12px}.ktg13-main{grid-template-columns:42% 58%}.ktg13-guest{font-size:12px}.ktg13-mid{flex-basis:70px;grid-template-columns:minmax(0,1fr) 40%;gap:5px}.ktg13-chat{height:70px;max-height:70px;padding-left:3px;padding-right:3px;transform:translateY(-24px)}.ktg13-chat-line{font-size:9px}.ktg13-earn{height:62px}.ktg13-earn #myEarnHud{padding:2px 4px!important}.ktg13-gifts{flex-basis:52px}.ktg13-gift img{height:23px}.ktg13-emoji{height:23px;font-size:20px}.ktg13-gift b{font-size:8px}.ktg13-gift small{font-size:6.5px}.ktg13-tools{flex-basis:47px}.ktg13-tool i{width:32px;height:32px;font-size:16px}.ktg13-tool span{font-size:8px}}'
      +'</style>'
