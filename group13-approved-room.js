...
(function(){
  ...
  function renderApprovedGroup13(){
    ...
    s.innerHTML='<style id="ktg13ApprovedStyle">'
      ...
      +'.ktg13-room[data-kt-room="13"] .ktg13-main{grid-template-columns:repeat(3,minmax(0,1fr))!important;grid-template-rows:minmax(72px,.72fr) repeat(4,minmax(0,1fr))!important;gap:2px!important}.ktg13-room[data-kt-room="13"] .ktg13-host{grid-column:1/4!important;grid-row:1!important}.ktg13-room[data-kt-room="13"] .ktg13-guests{display:contents!important}.ktg13-room[data-kt-room="13"] .ktg13-host>video{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center center!important}'
      ...
      +'@media(max-width:390px){.ktg13-room{padding-left:4px;padding-right:4px;gap:3px}.ktg13-head{flex-basis:58px;padding:4px 8px}.ktg13-air strong{font-size:18px}.ktg13-air small{font-size:10px}.ktg13-brand{font-size:17px}.ktg13-attend{min-width:112px;height:38px;font-size:17px;padding:0 9px}.ktg13-led{flex-basis:50px}.ktg13-led-track{font-size:21px}.ktg13-stats{flex-basis:42px;gap:4px}.ktg13-stats button,.ktg13-viewers{font-size:12px}.ktg13-main{grid-template-columns:42% 58%}.ktg13-room[data-kt-room="13"] .ktg13-main{grid-template-columns:repeat(3,minmax(0,1fr))!important;grid-template-rows:minmax(64px,.68fr) repeat(4,minmax(0,1fr))!important}.ktg13-guest{font-size:12px}.ktg13-mid{flex-basis:70px;grid-template-columns:minmax(0,1fr) 40%;gap:5px}.ktg13-chat{height:70px;max-height:70px;padding-left:3px;padding-right:3px}.ktg13-chat-line{font-size:9px}.ktg13-earn{height:62px}.ktg13-earn #myEarnHud{padding:2px 4px!important}.ktg13-gifts{flex-basis:52px}.ktg13-gift img{height:23px}.ktg13-emoji{height:23px;font-size:20px}.ktg13-gift b{font-size:8px}.ktg13-gift small{font-size:6.5px}.ktg13-tools{flex-basis:47px}.ktg13-tool i{width:32px;height:32px;font-size:16px}.ktg13-tool span{font-size:8px}}'
      +'</style>'
      +'<section class="ktg13-room" data-kt-room="13">'
