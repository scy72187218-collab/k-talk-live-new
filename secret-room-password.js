...
(function(){
  ...
  function renderSecretRoom(){
    ...
    screen.innerHTML='<style id="ktSecretApprovedStyle">'
      ...
      +'.ktsecret-earn-row{position:absolute;right:6px;bottom:70px;z-index:12;width:92px;height:50px;display:flex;align-items:center;justify-content:flex-end;padding:0}html body .ktsecret-room .ktsecret-earn-row #myEarnHud{width:92px!important;max-width:92px!important;min-width:92px!important;height:50px!important;max-height:50px!important;margin:0!important;padding:2px 3px!important;border:1px solid #d2a936!important;border-radius:10px!important;background:linear-gradient(135deg,#17140be8,#0d0d12e8)!important;color:#fff!important;overflow:hidden!important}html body .ktsecret-room .ktsecret-earn-row #myEarnHud span{font-size:5.8px!important;line-height:1!important}html body .ktsecret-room .ktsecret-earn-row #myEarnHud b{font-size:8px!important;line-height:1!important}html body .ktsecret-room .ktsecret-earn-row #myEarnDetail{font-size:5.4px!important;line-height:1!important;gap:1px!important;margin-top:1px!important}'
      +'.ktsecret-tools{flex:0 0 55px;display:grid;grid-template-columns:repeat(8,1fr);gap:2px}.ktsecret-tool{border:0;background:none;color:#fff;min-width:0;font-weight:900;display:grid;justify-items:center;gap:2px}.ktsecret-tool i{width:37px;height:37px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#1b1b20,#0b0b0f);border:1px solid #35363d;font-style:normal;font-size:18px}.ktsecret-tool span{font-size:8px;white-space:nowrap}'
      +'@media(max-width:390px){.ktsecret-room{padding-left:4px;padding-right:4px;gap:3px}.ktsecret-head{flex-basis:58px;padding:4px 7px}.ktsecret-title,.ktsecret-brand{font-size:17px}.ktsecret-att{min-width:82px;height:27px;font-size:10px}.ktsecret-att img{width:13px;height:13px}.ktsecret-airrow{flex-basis:31px;font-size:12px}.ktsecret-led{flex-basis:50px}.ktsecret-led-track{font-size:20px}.ktsecret-right{bottom:150px}.ktsecret-right button{width:40px;height:40px}.ktsecret-right .like{height:46px}.ktsecret-chat{left:5px;right:5px;bottom:92px;max-height:88px}.ktsecret-gifts{height:58px}.ktsecret-gift img,.ktsecret-emoji{height:26px}.ktsecret-earn-row{flex-basis:31px}html body .ktsecret-room .ktsecret-earn-row #myEarnHud{width:92px!important;max-width:92px!important;min-width:92px!important;height:50px!important;max-height:50px!important}.ktsecret-tools{flex-basis:50px}.ktsecret-tool i{width:33px;height:33px;font-size:16px}}'
      +'</style>'
