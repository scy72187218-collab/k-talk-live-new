...
(function(){
  ...
  function renderSecretRoom(){
    ...
    screen.innerHTML='<style id="ktSecretApprovedStyle">'
      ...
      +'.ktsecret-main{position:relative;flex:1 1 0;min-height:0;overflow:hidden;border-radius:10px;background:#111;border:1px solid rgba(255,196,73,.35)}.ktsecret-six-grid{position:absolute;inset:0;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));grid-template-rows:repeat(2,minmax(0,1fr));gap:3px;padding:3px}.ktsecret-slot{position:relative;min-width:0;min-height:0;overflow:hidden;border:1px solid rgba(255,255,255,.18);border-radius:8px;background:linear-gradient(145deg,#15151a,#09090c);display:flex;align-items:center;justify-content:center}.ktsecret-slot.host{border-color:rgba(255,208,90,.72);box-shadow:inset 0 0 0 1px rgba(255,208,90,.12)}.ktsecret-slot video,.ktsecret-slot .ktsecret-guest-photo{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:50% 50%;background:#111}.ktsecret-slot video{transform:scaleX(-1);filter:brightness(1.08) contrast(.95) saturate(1.02)}.ktsecret-slot .ktsecret-guest-photo{transform:none;filter:brightness(1.03) contrast(.97) saturate(1.03)}.ktsecret-slot-label{position:absolute;left:5px;bottom:5px;z-index:3;padding:2px 6px;border-radius:999px;background:rgba(0,0,0,.62);color:#fff;font-size:9px;font-weight:900}.ktsecret-slot.host .ktsecret-slot-label{color:#ffe071}.ktsecret-guest-wait{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;color:#bdbdc7;font-size:10px;font-weight:850}.ktsecret-guest-wait b{display:grid;place-items:center;width:30px;height:30px;border-radius:50%;border:1px solid rgba(255,255,255,.25);font-size:20px;color:#fff}.ktsecret-shade{position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(0,0,0,.06) 65%,rgba(0,0,0,.55) 100%);pointer-events:none}'
      ...
      +'.ktsecret-chat{position:absolute;left:8px;right:8px;bottom:70px;z-index:8;max-height:94px;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;padding:5px 5px 6px;background:linear-gradient(90deg,rgba(0,0,0,.52),rgba(0,0,0,.15) 74%,transparent);border-radius:9px}.ktsecret-chat:empty:before{content:"💬 채팅 메시지가 여기에 표시됩니다";color:#ddd;font-size:11px;font-weight:850}.ktsecret-chat-line{display:flex;gap:7px;margin-top:4px;font-size:11px;font-weight:850}.ktsecret-chat-line b{color:#65c8ff}.ktsecret-chat-line span{color:#fff}'
      ...
      +'<section class="ktsecret-room">'
        ...
        +'<div class="ktsecret-main"><div class="ktsecret-six-grid"><div class="ktsecret-slot host"><video id="ktLiveVideo" autoplay playsinline muted></video><span class="ktsecret-slot-label">호스트</span></div><div class="ktsecret-slot"><img class="ktsecret-guest-photo" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=500&q=80" alt="게스트 1"><span class="ktsecret-slot-label">게스트 1</span></div><div class="ktsecret-slot"><img class="ktsecret-guest-photo" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=500&q=80" alt="게스트 2"><span class="ktsecret-slot-label">게스트 2</span></div><div class="ktsecret-slot"><img class="ktsecret-guest-photo" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=500&q=80" alt="게스트 3"><span class="ktsecret-slot-label">게스트 3</span></div><div class="ktsecret-slot"><img class="ktsecret-guest-photo" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=500&q=80" alt="게스트 4"><span class="ktsecret-slot-label">게스트 4</span></div><div class="ktsecret-slot"><div class="ktsecret-guest-wait"><b>+</b><span>게스트 5</span></div></div></div><div class="ktsecret-shade"></div>'
          ...
          +'<div id="ktsecretChatList" class="ktsecret-chat" style="left:8px!important;right:8px!important;bottom:70px!important"></div>'
