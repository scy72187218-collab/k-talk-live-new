...
(function(){
  ...
  function renderSecretRoom(){
    ...
    screen.innerHTML='<style id="ktSecretApprovedStyle">'
      ...
      +'.ktsecret-main{position:relative;flex:1 1 0;min-height:0;overflow:hidden;border-radius:10px;background:#111;border:1px solid rgba(255,196,73,.35)}.ktsecret-six-grid{position:absolute;inset:0;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:minmax(0,2.35fr) minmax(0,1fr);gap:3px;padding:3px}.ktsecret-slot{position:relative;min-width:0;min-height:0;overflow:hidden;border:1px solid rgba(255,255,255,.18);border-radius:8px;background:linear-gradient(145deg,#15151a,#09090c);display:flex;align-items:center;justify-content:center}.ktsecret-slot.host{grid-column:1/-1;grid-row:1;border-color:rgba(255,208,90,.72);box-shadow:inset 0 0 0 1px rgba(255,208,90,.12)}.ktsecret-slot video,.ktsecret-slot .ktsecret-guest-photo{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:50% 50%;background:#111}.ktsecret-slot video{transform:scaleX(-1);filter:brightness(1.08) contrast(.95) saturate(1.02)}.ktsecret-slot .ktsecret-guest-photo{transform:none;filter:brightness(1.03) contrast(.97) saturate(1.03)}.ktsecret-slot-label{position:absolute;left:5px;bottom:5px;z-index:3;padding:2px 6px;border-radius:999px;background:rgba(0,0,0,.62);color:#fff;font-size:9px;font-weight:900}.ktsecret-slot.host .ktsecret-slot-label{color:#ffe071}.ktsecret-guest-wait{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;color:#bdbdc7;font-size:10px;font-weight:850}.ktsecret-guest-wait b{display:grid;place-items:center;width:30px;height:30px;border-radius:50%;border:1px solid rgba(255,255,255,.25);font-size:20px;color:#fff}.ktsecret-shade{position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(0,0,0,.06) 65%,rgba(0,0,0,.55) 100%);pointer-events:none}'
