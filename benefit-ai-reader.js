...
/* 촬영 화면 정렬: 상단 줄과 오른쪽 도구만 이전보다 조금 아래로 내림. 다른 화면은 변경하지 않음. */
(function(){
  ...
  s.textContent=''
    +'#creator .creator-top{top:12px!important;left:10px!important;right:10px!important}'
    +'#creator .creator-tools{top:72px!important;right:12px!important;bottom:auto!important;gap:10px!important;transform:none!important;align-items:center!important}'
    ...
    +'@media(max-width:390px){#creator .creator-top{top:10px!important;left:8px!important;right:8px!important}#creator .creator-tools{top:66px!important;right:8px!important;gap:8px!important}}';
  document.head.appendChild(s);
})();
