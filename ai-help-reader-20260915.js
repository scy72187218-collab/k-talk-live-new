  ...
  function fullGuideHtml(){
    return '<section id="ktFullGuide20260915" style="margin:12px 0 4px;padding:13px;border:1px solid rgba(255,255,255,.14);border-radius:16px;background:rgba(10,10,16,.72);color:#fff;text-align:left;line-height:1.55">'
      ...
      +'<div style="display:grid;gap:10px;font-size:13px">'
        ...
        +'<div><b style="color:#74e7ff">13. 프로필 사진 누르기</b><br>방송 중 본인 사진이나 다른 사람 사진을 누르면 크게 볼 수 있습니다. 확대 화면 안에는 마이크, 사진, 장미 1송이, 보물상자 기능이 표시됩니다. 다른 사람을 선택한 상태에서 장미를 누르면 그 사람에게 장미 1송이를 보낼 수 있습니다.</div>'
        +'<div><b style="color:#74e7ff">14. 친구 · 팔로우 상태</b><br>친구를 누르면 팔로우한 친구가 동그란 프로필로 표시됩니다. 방송 중인 친구는 빨간 테두리와 LIVE 표시, 방송하지 않는 친구는 파란 테두리로 구분됩니다. 프로필 안에는 레벨, 아래에는 닉네임과 상태가 표시됩니다.</div>'
        +'<div><b style="color:#74e7ff">15. 친구 방송 바로 입장</b><br>빨간 LIVE 친구를 누르면 바로 그 친구 방송으로 들어갑니다. 방송하지 않는 친구를 누르면 프로필을 확인할 수 있습니다.</div>'
        +'<div><b style="color:#74e7ff">16. 팔로워 방송 알림</b><br>내가 팔로우한 사람이 방송을 시작하면 방송 시작 알림이 표시되고 입장을 누르면 바로 들어갈 수 있습니다. 같은 방송 알림은 반복해서 계속 뜨지 않도록 처리됩니다.</div>'
        +'<div><b style="color:#74e7ff">17. 게스트 화면 상단 기능</b><br>1인 방송, 9명 방송, 13명 방송, 구독자방, 비밀방의 게스트 화면에서는 되돌리기, 보물상자, 매치를 사용할 수 있습니다. 일일 랭킹, 미션, 시청자 정보도 함께 확인할 수 있습니다.</div>'
        +'<div><b style="color:#74e7ff">18. 게스트 참여</b><br>게스트는 참여 신청을 누른 뒤 호스트가 승인하면 방송 화면에 올라갑니다. 승인 전에는 게스트로 올라가지 않으며, 승인 후에는 호스트 화면과 게스트 화면에 각각 실제 카메라 영상이 표시됩니다.</div>'
        +'<div><b style="color:#74e7ff">19. 배경 효과</b><br>편집 효과에서 콘서트 무대, 네온 무대, 클럽, 바다, 해변 노을, 야경, 별빛, 우주, 꽃밭, 폭죽 무대 등을 선택할 수 있습니다. 기본 방송은 AI를 사용하지 않고, 배경 효과를 선택할 때만 사람과 배경을 분리하는 AI가 켜집니다.</div>'
        +'<div><b style="color:#74e7ff">20. 얼굴 보정</b><br>보정 화면에서 전체 보정, 피부, 밝기, 눈, 입술, 코, 귀, 턱, 얼굴 작게, 턱선을 1부터 100까지 조절할 수 있습니다. 기본 보정은 AI 없이 안정적으로 작동하고, 세부 얼굴 형태 조절은 휴대폰 지원 상태에 따라 차이가 있을 수 있습니다.</div>'
        +'<div><b style="color:#74e7ff">21. 장미 · 보물상자</b><br>장미 버튼은 선택한 사람에게 바로 장미를 보내는 데 사용할 수 있고, 보물상자는 방송 중 열어서 참여하거나 선물을 확인할 수 있습니다. 실제 수량과 지급 조건은 현재 화면 표시를 확인합니다.</div>'
        +'<div><b style="color:#74e7ff">22. 방송 상태 색상</b><br>친구 목록에서 빨간색은 현재 방송 중, 파란색은 현재 방송하지 않는 상태를 뜻합니다. LIVE 표시가 있는 사람은 바로 방송 입장이 가능합니다.</div>'
        +'<div><b style="color:#74e7ff">23. 호스트 · 운영진 영상·TV</b><br>호스트 화면의 영상·TV 기능에서 유튜브 주소나 재생 가능한 영상 주소를 넣어 영상을 볼 수 있습니다. 지원되는 휴대폰과 브라우저에서는 TV 연결 기능을 이용할 수 있습니다. 이 기능은 호스트와 운영진용이며 일반 시청자와 게스트에게는 조작 버튼을 제공하지 않습니다.</div>'
        +'<div><b style="color:#74e7ff">24. 영화 · 유튜브 · 저작권</b><br>영화, 방송, 유튜브 영상은 언어와 관계없이 저작권이 있을 수 있습니다. 영어 영상도 저작권 보호 대상일 수 있으므로, 본인이 만든 영상, 사용 허가를 받은 영상, 저작권이 만료된 영상, 또는 방송·상업 이용이 허용된 라이선스 영상만 사용하세요.</div>'
        +'<div><b style="color:#74e7ff">25. TV 연결 주의</b><br>TV 연결은 휴대폰, 브라우저, 스마트TV가 지원하는 방식에 따라 달라집니다. 연결되더라도 저작권 제한이나 서비스 정책 때문에 일부 영상은 TV 또는 외부 화면에서 재생되지 않을 수 있습니다.</div>'
      +'</div>'
