...
(function(){
  ...
  s.onload=function(){
    ...
    v.src='live-video-discovery.js?v=20260921-integrated-live2';
    v.async=false;
...
(function(){
  ...
  var s=document.createElement('script');
  s.src='live-chat-send-arrow.js?v=20260921-realtime-guest-full1';
  s.async=false;
...
(function(){
  ...
  var s=document.createElement('script');
  s.src='live-presence-watchdog.js?v=20260921-integrated-live2';
  s.async=false;
