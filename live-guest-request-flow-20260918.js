        ...
        pc.ontrack=(function(target,viewer){
          return function(ev){
            ...
            if(v){
              ...
              v.style.setProperty('transform','scaleX(-1) scale(.5)','important');
