...
(function(){
  ...
  function renderApprovedSubscriber(){
    ...
    screen.innerHTML='<style id="ktSubscriberApprovedStyle">'
      ...
      +'.ktsubscriber-info{flex:0 0 82px;display:grid;grid-template-columns:minmax(0,1fr) 205px;align-items:stretch;gap:6px;padding:2px 0;overflow:hidden}.ktsubscriber-leftinfo{min-width:0;min-height:0;display:flex;flex-direction:column;overflow:hidden}.ktsubscriber-chat{flex:1 1 0;min-width:0;min-height:0;overflow:hidden;padding:0 7px;display:flex;flex-direction:column;justify-content:flex-end;cursor:pointer;background:transparent;transform:translateY(-28px);position:relative;z-index:6}.ktsubscriber-chat-hint{font-size:10px;font-weight:850;color:#eee;text-shadow:0 1px 3px #000}.ktsubscriber-chat-line{display:flex;gap:6px;font-size:10px;font-weight:850;text-shadow:0 1px 3px #000}.ktsubscriber-chat-line b{color:#65c8ff}.ktsubscriber-chat-line span{color:#fff}'
      ...
      +'.ktsubscriber-tools{flex:0 0 58px;display:grid;grid-template-columns:repeat(8,1fr);gap:2px;align-items:start;background:#000}.ktsubscriber-tool{border:0;background:none;color:#fff;min-width:0;font-weight:900;display:grid;justify-items:center;gap:2px}.ktsubscriber-tool i{width:36px;height:36px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#1b1b20,#0b0b0f);border:1px solid #35363d;font-style:normal;font-size:17px}.ktsubscriber-tool span{font-size:8px;color:#fff;white-space:nowrap}'
      +'@media(max-width:390px){.ktsubscriber-room{padding-left:4px;padding-right:4px;gap:3px}.ktsubscriber-head{flex-basis:55px;padding:4px 6px}.ktsubscriber-title,.ktsubscriber-brand{font-size:16px}.ktsubscriber-att{min-width:82px;height:27px;font-size:10px}.ktsubscriber-air{flex-basis:29px;font-size:12px}.ktsubscriber-led{flex-basis:46px}.ktsubscriber-led-track{font-size:19px}.ktsubscriber-stage{grid-template-columns:minmax(0,1fr) 46px;gap:3px}.ktsubscriber-people{gap:2px}.ktsubscriber-host,.ktsubscriber-guest{border-color:rgba(255,255,255,.06);border-radius:6px}.ktsubscriber-right{gap:5px}.ktsubscriber-right button{width:40px;height:40px;font-size:14px}.ktsubscriber-right .like{height:48px;border-radius:17px}.ktsubscriber-info{grid-template-columns:minmax(0,1fr) 165px;flex-basis:76px;gap:3px}.ktsubscriber-chat-hint{font-size:9px}.ktsubscriber-chat{transform:translateY(-24px)}.ktsubscriber-wave{flex-basis:34px}.ktsubscriber-earnhud{padding:4px 6px!important}.ktsubscriber-gifts{flex-basis:58px}.ktsubscriber-gift img,.ktsubscriber-emoji{height:25px}.ktsubscriber-tools{flex-basis:52px}.ktsubscriber-tool i{width:32px;height:32px;font-size:15px}.ktsubscriber-tool span{font-size:7px}}'
      +'</style>'
