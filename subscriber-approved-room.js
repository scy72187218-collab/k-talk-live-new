...
(function(){
  ...
  function renderApprovedSubscriber(){
    ...
    screen.innerHTML='<style id="ktSubscriberApprovedStyle">'
      ...
      +'.ktsubscriber-people{min-height:0;display:grid;grid-template-columns:40% 30% 30%;grid-template-rows:repeat(2,minmax(0,1fr));gap:3px;overflow:hidden}'
      ...
      +'.ktsubscriber-guest:nth-child(2){grid-column:2;grid-row:1}.ktsubscriber-guest:nth-child(3){grid-column:3;grid-row:1}.ktsubscriber-guest:nth-child(4){grid-column:2;grid-row:2}.ktsubscriber-guest:nth-child(5){grid-column:3;grid-row:2}'
      +'.ktsubscriber-right{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;min-width:0}.ktsubscriber-right button{width:48px;height:48px;border-radius:50%;border:0;background:rgba(16,16,20,.72);color:#fff;font-size:17px;font-weight:950;box-shadow:none}.ktsubscriber-right .like{height:58px;border-radius:21px;border:0;background:rgba(50,16,36,.72)}.ktsubscriber-right small{display:block;font-size:8px;line-height:1.05;margin-top:1px;white-space:nowrap}.ktsubscriber-right .like b{display:block;font-size:8px}'
      +'.ktsubscriber-info{flex:0 0 54px;display:grid;grid-template-columns:minmax(0,1fr) 205px;align-items:center;gap:6px;padding:2px 0;overflow:hidden}.ktsubscriber-chat{min-width:0;max-height:50px;overflow:hidden;padding:0 7px;display:flex;flex-direction:column;justify-content:flex-end;cursor:pointer;background:transparent}.ktsubscriber-chat-hint{font-size:10px;font-weight:850;color:#eee;text-shadow:0 1px 3px #000}.ktsubscriber-chat-line{display:flex;gap:6px;font-size:10px;font-weight:850;text-shadow:0 1px 3px #000}.ktsubscriber-chat-line b{color:#65c8ff}.ktsubscriber-chat-line span{color:#fff}'
      +'.ktsubscriber-earn{min-width:0;overflow:hidden}.ktsubscriber-earn #myEarnHud{position:static!important;left:auto!important;right:auto!important;bottom:auto!important;transform:none!important;width:100%!important;margin:0!important;padding:5px 8px!important;border:1px solid rgba(210,169,54,.72)!important;border-radius:13px!important;background:linear-gradient(135deg,#17140b,#0d0d12)!important;color:#fff!important}'
      ...
      +'<section class="ktsubscriber-room">'
        ...
        +'<div class="ktsubscriber-main">'
          ...
          +'</div>'
          +'<div class="ktsubscriber-info"><div id="ktsubscriberChatList" class="ktsubscriber-chat" onclick="ktSubscriberOpenMessage()"></div><div class="ktsubscriber-earn"><button id="myEarnHud" onclick="toggleMyEarnings()"><div style="display:flex;align-items:center;justify-content:center;gap:5px"><span style="font-size:8px;color:#8fe8ff;font-weight:950;white-space:nowrap">🔒 내 수익 · 본인만 표시</span><b id="hudEarnNet" style="font-size:12px;color:#ffe071;white-space:nowrap">'+esc(net)+'</b></div><div id="myEarnDetail" style="display:none;grid-template-columns:1fr 1fr;gap:4px;margin-top:2px;font-size:7px;color:#ddd"><span id="hudEarnRoses">'+esc(roses)+'</span><span style="text-align:right">일반회원 35%</span><span>구독자회원 40%</span><span style="text-align:right">소속사 65%</span></div></button></div></div>'
