...
(function(){
  ...
  function renderApprovedSubscriber(){
    ...
    screen.innerHTML='<style id="ktSubscriberApprovedStyle">'
      ...
      +'.ktsubscriber-att{justify-self:center;height:36px;min-width:120px;padding:0 6px;border-radius:19px;border:2px solid #ff2bbd;background-color:#130714;background-image:radial-gradient(circle,#ff35ce 1.5px,transparent 2px);background-size:8px 8px;color:#ffd52f;font-size:15px;font-weight:950;box-shadow:0 0 8px #ff2bbd,0 0 18px #ff2bbd66;display:flex;align-items:center;justify-content:center;gap:4px;white-space:nowrap}.ktsubscriber-att img{width:19px;height:19px;object-fit:contain;filter:drop-shadow(0 0 5px #41b8ff)}'
      ...
      +'@media(max-width:390px){.ktsubscriber-room{padding-left:4px;padding-right:4px;gap:3px}.ktsubscriber-head{flex-basis:58px;padding:4px 7px}.ktsubscriber-title{font-size:17px}.ktsubscriber-brand{font-size:17px}.ktsubscriber-att{min-width:102px;height:32px;font-size:13px;padding:0 4px}.ktsubscriber-att img{width:17px;height:17px}.ktsubscriber-air{flex-basis:31px;font-size:12px}.ktsubscriber-led{flex-basis:50px}.ktsubscriber-led-track{font-size:20px}.ktsubscriber-right{bottom:150px}.ktsubscriber-right button{width:40px;height:40px}.ktsubscriber-right .like{height:46px}.ktsubscriber-earn{left:auto;right:5px;bottom:64px;transform:none;width:128px;max-width:40%}.ktsubscriber-chat{right:140px;bottom:64px;max-height:88px}.ktsubscriber-gifts{height:58px}.ktsubscriber-gift img,.ktsubscriber-emoji{height:26px}.ktsubscriber-tools{flex-basis:50px}.ktsubscriber-tool i{width:33px;height:33px;font-size:16px}}'
      +'</style>'
