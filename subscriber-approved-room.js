...
(function(){
  ...
  function renderApprovedSubscriber(){
    ...
    screen.innerHTML='<style id="ktSubscriberApprovedStyle">'
      ...
      +'.ktsubscriber-host,.ktsubscriber-guest{position:relative;min-width:0;min-height:0;border:2px solid #ff2dbd;border-radius:8px;overflow:hidden;background:linear-gradient(145deg,#17181d,#0e0f13);box-shadow:0 0 7px rgba(255,45,189,.24)}'
      ...
      +'.ktsubscriber-earn #myEarnHud{width:100%!important;margin:0!important;padding:5px 8px!important;border:1px solid #d2a936!important;border-radius:13px!important;background:linear-gradient(135deg,#17140b,#0d0d12)!important;color:#fff!important}'
