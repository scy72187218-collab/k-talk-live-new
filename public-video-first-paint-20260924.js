...
(function(){
  ...
  function firstUrl(){
    try{
      ...
      if(Array.isArray(a)&&a[0]&&a[0].video_url)return String(a[0].video_url||'').trim();
    }catch(e){}
    return 'https://zupwbfmacwzexyvznlzq.supabase.co/storage/v1/object/public/ktalk-videos/guest/1789858184221-0lyob9.mp4';
  }
