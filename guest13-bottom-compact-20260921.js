...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=''
      ...
      +'.kt-remote-live.kt-guest13-bottom-compact .kt-allroom-guest-earn{position:fixed!important;width:112px!important;min-width:112px!important;max-width:112px!important;height:64px!important;max-height:64px!important;right:8px!important;bottom:92px!important;padding:3px 4px!important;border-radius:9px!important;z-index:2147482490!important;box-sizing:border-box!important;overflow:hidden!important}'
      +'.kt-remote-live.kt-guest13-bottom-compact .kt-allroom-guest-earn .kt-ge-top{gap:1px!important}'
      +'.kt-remote-live.kt-guest13-bottom-compact .kt-allroom-guest-earn .kt-ge-top span{font-size:5.2px!important}'
      +'.kt-remote-live.kt-guest13-bottom-compact .kt-allroom-guest-earn .kt-ge-top b{font-size:8px!important}'
      +'.kt-remote-live.kt-guest13-bottom-compact .kt-allroom-guest-earn .kt-ge-detail{font-size:5px!important;gap:1px 2px!important;line-height:1.08!important;margin-top:2px!important}'
      +'.kt-remote-live.kt-guest13-bottom-compact .kt-allroom-guest-earn .kt-ge-detail .note{font-size:4.7px!important}'
      +'.kt-remote-live.kt-guest13-bottom-compact .kgh-earn{position:fixed!important;width:112px!important;min-width:112px!important;max-width:112px!important;height:62px!important;max-height:62px!important;right:8px!important;bottom:92px!important;padding:3px 4px!important;border-radius:9px!important;z-index:2147482490!important;box-sizing:border-box!important;overflow:hidden!important}'
  ...
  function force(root){
    try{
      ...
      if(generic){
        generic.style.setProperty('position','fixed','important');
        generic.style.setProperty('width','112px','important');
        generic.style.setProperty('min-width','112px','important');
        generic.style.setProperty('max-width','112px','important');
        generic.style.setProperty('height','64px','important');
        generic.style.setProperty('max-height','64px','important');
        generic.style.setProperty('right','8px','important');
        generic.style.setProperty('bottom','92px','important');
        generic.style.setProperty('padding','3px 4px','important');
      }
      ...
      if(earn){
        ...
        earn.style.setProperty('bottom','92px','important');
        earn.style.setProperty('z-index','2147482490','important');
      }
    }catch(e){}
  }
