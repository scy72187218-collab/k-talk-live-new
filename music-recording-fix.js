...
(function(){
  ...
  load('group9-approved-room.js?v=20260919-nine-touchgift1');
  ...
  load('live-presence.js?v=20260921-all-end-video1');
  load('live-presence-watchdog.js?v=20260921-live-steady-final1');
})();
