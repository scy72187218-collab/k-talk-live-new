...
(function(){
  ...
  function renderApprovedSolo(){
    ...
    screen.innerHTML='<style id="ktSoloApprovedStyle">'
      ...
      +'.ktsolo-chat{position:absolute;left:10px;right:120px;bottom:132px;z-index:12;max-height:170px;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;padding:4px 5px;background:transparent;border:0;border-radius:0;pointer-events:none}.ktsolo-chat:empty:before{content:"💬 채팅 메시지가 여기에 표시됩니다";color:#ddd;font-size:11px;font-weight:850;text-shadow:0 1px 3px #000}.ktsolo-chat-line{display:flex;gap:7px;align-items:baseline;margin-top:4px;font-size:11px;font-weight:850;text-shadow:0 1px 3px #000;animation:ktsoloChatRise .22s ease-out}.ktsolo-chat-line b{color:#65c8ff;font-weight:950}.ktsolo-chat-line span{color:#fff}@keyframes ktsoloChatRise{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}'
