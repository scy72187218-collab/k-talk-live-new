...
(function(){
  ...
  function renderApprovedSolo(){
    ...
    screen.innerHTML='<style id="ktSoloApprovedStyle">'
      ...
      +'.ktsolo-tools{flex:0 0 55px;display:grid;grid-template-columns:repeat(8,1fr);gap:2px;align-items:start}.ktsolo-tool{border:0;background:none;color:#fff;min-width:0;font-weight:900;display:grid;justify-items:center;gap:2px}.ktsolo-tool i{width:37px;height:37px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#1b1b20,#0b0b0f);border:1px solid #35363d;font-style:normal;font-size:18px;box-shadow:inset 0 0 13px #ffffff08}.ktsolo-tool:first-child i{box-shadow:0 0 12px #a53fff66,inset 0 0 13px #ffffff08}.ktsolo-tool span{font-size:8px;color:#fff;white-space:nowrap}'
