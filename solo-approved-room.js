...
(function(){
  ...
  function renderApprovedSolo(){
    ...
    screen.innerHTML='<style id="ktSoloApprovedStyle">'
      ...
      +'.ktsolo-main{position:relative;flex:1 1 0;min-height:0;overflow:hidden;border-radius:10px;background:#111}.ktsolo-main .ktsolo-fill-video{position:absolute;inset:-8%;width:116%;height:116%;object-fit:cover;object-position:50% 50%;transform:scaleX(-1);filter:blur(24px) brightness(.42) saturate(.78);opacity:1;background:#111;z-index:0}.ktsolo-main #ktLiveVideo{position:absolute;left:18px;bottom:78px;top:auto;right:auto;width:34%;height:46%;object-fit:cover;object-position:50% 50%;transform:scaleX(-1);transform-origin:50% 50%;background:#111;filter:brightness(1.08) contrast(.95) saturate(1.02);z-index:5;border-radius:16px;box-shadow:0 4px 18px #000b;border:1px solid #ffffff42}.ktsolo-shade{position:absolute;inset:0;background:linear-gradient(180deg,transparent 50%,rgba(0,0,0,.06) 65%,rgba(0,0,0,.55) 100%);pointer-events:none;z-index:2}'
