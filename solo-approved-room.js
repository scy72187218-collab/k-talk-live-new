...
(function(){
  ...
  function renderApprovedSolo(){
    ...
    screen.innerHTML='<style id="ktSoloApprovedStyle">'
      ...
      +'.ktsolo-earn{position:absolute;left:auto;right:8px;bottom:82px;transform:scale(.62);transform-origin:bottom right;z-index:10;width:92px;max-width:22%}.ktsolo-earn #myEarnHud{position:static!important;transform:none!important;width:100%!important;margin:0!important;padding:2px 3px!important;border:1px solid #d2a936!important;border-radius:9px!important;background:linear-gradient(135deg,#17140be8,#0d0d12e8)!important;color:#fff!important}.ktsolo-earn #myEarnHud>div:first-child{gap:1px!important}.ktsolo-earn #myEarnHud>div:first-child span{font-size:5px!important}.ktsolo-earn #hudEarnNet{font-size:8px!important}'
