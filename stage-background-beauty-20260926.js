...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=''
      +'.kt-fx-sheet{padding:0 0 6px;color:#fff}.kt-fx-head{display:flex;align-items:center;gap:6px;margin:0 0 5px}.kt-fx-back{width:30px;height:30px;border:0;border-radius:50%;background:#262834;color:#fff;font-size:22px;font-weight:900;line-height:1}.kt-fx-title{flex:1;font-weight:950;font-size:13px;margin:0}.kt-fx-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:4px}.kt-fx-bg{height:42px;border:1px solid #ffffff33;border-radius:10px;color:#fff;font-size:12px;font-weight:900;text-shadow:0 1px 4px #000;background:#17171b;background-size:cover!important}.kt-fx-bg.on{outline:2px solid #50d8ff;outline-offset:0}.kt-fx-note{font-size:8px;color:#bbb;margin:5px 2px 0;line-height:1.25}.kt-fx-apply{width:100%;height:40px;margin-top:6px;border:0;border-radius:11px;background:linear-gradient(135deg,#ff315f,#8b55ff);color:#fff;font-size:13px;font-weight:950}.kt-beauty-row{display:grid;grid-template-columns:76px 1fr 34px;gap:7px;align-items:center;margin:8px 0}.kt-beauty-row label{font-size:11px;font-weight:900}.kt-beauty-row input{width:100%}.kt-beauty-row output{text-align:right;font-size:10px;color:#9fe7ff}.kt-beauty-reset{width:100%;height:38px;margin-top:8px;border:0;border-radius:10px;background:#22242a;color:#fff;font-weight:900}';
