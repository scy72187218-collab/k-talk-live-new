/* K-Talk LIVE: enlarge yellow attendance text, move attendance boards a little lower, and animate the lower LED board in all 4 rooms. */
(function(){
...
#ktSept2Live .kt-s2-attendance-stack .kt-s2-att-large{font-size:22px!important;font-weight:950!important;line-height:1!important;animation:ktAttendanceLedChase 1.15s linear infinite!important;}\
#ktSept2Live .kt-s2-attendance-stack .kt-s2-att-large b{font-size:22px!important;font-weight:950!important;animation:ktAttendanceTextGlow 1.15s ease-in-out infinite!important;}\
/* 비밀방 */\
...
html.kt-password-reference body #ktSept2Live #ktPasswordAttendance .large{font-size:22px!important;font-weight:950!important;line-height:1!important;animation:ktAttendanceLedChase 1.15s linear infinite!important;}\
html.kt-password-reference body #ktSept2Live #ktPasswordAttendance .large{animation-name:ktAttendanceLedChase,ktAttendanceTextGlow!important;animation-duration:1.15s,1.15s!important;animation-timing-function:linear,ease-in-out!important;animation-iteration-count:infinite,infinite!important;}\
';
