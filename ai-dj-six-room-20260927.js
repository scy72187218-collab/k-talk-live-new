    ...
    screen.innerHTML=''
      ...
      +'<section class="kt-ai-dj-six-room" data-kt-ai-dj="1" data-kt-room="ai-dj-6">'
        ...
        +'<div class="ktadj6-stage">'
          ...
          +'</div>'
          +'<aside class="ktadj6-gifts"><h4>장미 선물</h4>'
            +'<button class="ktadj6-gift" onclick="if(window.openGifts)openGifts()"><i>🌹</i><span><b>장미 1송이</b><small>1송</small></span></button>'
            +'<button class="ktadj6-gift" onclick="if(window.openGifts)openGifts()"><i>🌹</i><span><b>장미 10송이</b><small>10송</small></span></button>'
            +'<button class="ktadj6-gift" onclick="if(window.openGifts)openGifts()"><i>🌹</i><span><b>장미 20송이</b><small>20송</small></span></button>'
            +'<button class="ktadj6-gift" onclick="if(window.openGifts)openGifts()"><i>🌹</i><span><b>장미 30송이</b><small>30송</small></span></button>'
            +'<button class="ktadj6-gift" onclick="if(window.openGifts)openGifts()"><i>🌹</i><span><b>장미 40송이</b><small>40송</small></span></button>'
            +'<button class="ktadj6-gift big" onclick="if(window.openGifts)openGifts()"><i>🌹</i><span><b>장미 50송이</b><small>50송</small></span></button>'
          +'</aside>'
        +'</div>'
