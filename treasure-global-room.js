...
(function(){
  ...
  function loadTreasureHostHeadFallback(){
    var s=document.createElement('script');
    s.src='treasure-host-head-fallback.js?v=20260912-hosthead1';
    s.async=false;
    document.head.appendChild(s);
  }
  ...
  function loadAllSwitchesFix(){
    if(document.querySelector('script[data-kt-all-switches-fix]'))return;
    var s=document.createElement('script');
    s.src='all-switches-fix.js?v=20260912-switches1';
    s.async=false;
    s.setAttribute('data-kt-all-switches-fix','1');
    document.head.appendChild(s);
  }

  function loadHostFaceLikeFix(){
    if(document.querySelector('script[data-kt-host-face-like]'))return;
    var s=document.createElement('script');
    s.src='host-face-like-reward.js?v=20260912-hostlike2';
    s.async=false;
    s.setAttribute('data-kt-host-face-like','1');
    document.head.appendChild(s);
  }
