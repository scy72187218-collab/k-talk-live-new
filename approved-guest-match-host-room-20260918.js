...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=''
      ...
      +'.kgh-earn{position:absolute;right:4px;bottom:1px;z-index:6;width:88px;height:43px;border:1px solid #d2a936;border-radius:9px;background:linear-gradient(135deg,#17140be8,#0d0d12e8);color:#fff;padding:2px 3px;text-align:center;overflow:hidden}.kgh-earn .top{display:flex;align-items:center;justify-content:center;gap:2px;white-space:nowrap}.kgh-earn .top span{font-size:5.5px;color:#8fe8ff;font-weight:950}.kgh-earn .top b{font-size:8px;color:#ffe071}.kgh-earn-detail{display:grid;grid-template-columns:1fr 1fr;gap:1px;margin-top:2px;font-size:5.5px;color:#ddd;white-space:nowrap}'
