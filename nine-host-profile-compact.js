...
(function(){
  ...
  s.textContent=''
    ...
    +'.ktg13-room[data-kt-room="9"] .kt-inside-mic,.ktg13-room[data-kt-room="9"] .kt-person-mic,.ktg13-room[data-kt-room="9"] button[aria-label*="마이크"],.ktg13-room[data-kt-room="9"] button[title*="마이크"]{display:none!important}'
    +'.ktg13-room[data-kt-room="9"] .ktg13-earn #myEarnHud{transform:scale(.9)!important;transform-origin:right bottom!important}'
