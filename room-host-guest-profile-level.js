...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=''
      ...
      +'.ktg13-room[data-kt-room="9"] .ktg13-host>.kt-hg-host-identity{top:34px!important}'
