...
html body #ktSept2Live.kt-added-ui-room .kt-s2-attendance-stack{gap:2px!important;width:82%!important;margin:0 auto!important;}\
html body #ktSept2Live.kt-added-ui-room .kt-s2-attendance-stack button{border-width:1px!important;background-size:6px 6px!important;box-shadow:inset 0 0 7px #ff37c43d,0 0 5px #ff40c9,0 0 10px #ff2ab990!important;}\
html body #ktSept2Live.kt-added-ui-room .kt-s2-att-small{height:22px!important;min-width:112px!important;width:46%!important;padding:0 6px!important;border-radius:10px!important;font-size:10px!important;}\
html body #ktSept2Live.kt-added-ui-room .kt-s2-att-large{width:86%!important;height:30px!important;padding:0 7px!important;border-radius:12px!important;font-size:14px!important;}\
...
@media(max-width:380px){.kt-att-led-target .kt-live-attendance{left:130px!important;right:5px!important;font-size:12px!important}.kt-att-led-target .kt-live-attendance .badge{font-size:12px!important}#ktSoloHostLive .kt-sa-att{left:136px!important;right:44px!important}#ktSoloHostLive .kt-sa-att:before{font-size:12px!important}html body #ktSept2Live.kt-added-ui-room .kt-s2-att-large{font-size:13px!important}html body #ktSept2Live.kt-added-ui-room .kt-s2-gift-row small{font-size:6px!important}}\
';
