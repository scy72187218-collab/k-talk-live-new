...
(function(){
  ...
  load('chat-benefit-ai-reader.js','__ktChatBenefitAIReaderInstalled',function(){
    load('live-presence.js?v=20260918-live-off-stable1','__ktLivePresenceInstalled',function(){
      load('live-video-discovery.js?v=20260919-no-plus-bell2','__ktLiveVideoDiscoveryInstalled',function(){
  ...
  load('approved-guest-match-host-room-20260918.js?v=20260918-attend-exitfix1','__ktApprovedGuestMatchHostRoom20260918');
